...
<html>
	...
	<body>
		...
		<br/><br/>
		<span>Action=http://<%=serverName%>:8080/test/plain/post/result.jsp?param3=param3val</span>
		<form method="post" action="http://<%=serverName%>:8080/test/plain/post/result.jsp?param3=param3val" name="crossDomainForm">		
